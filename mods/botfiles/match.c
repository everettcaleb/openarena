...
MTCONTEXT_INITIALTEAMCHAT
{
	...
	//double domination commands
	EC"("|EC"[", NETNAME, EC")"|EC"]", PLACE, EC": ", ADDRESSEE, " dominate point A" = (MSG_TAKEA, ST_ADDRESSED);
	EC"("|EC"[", NETNAME, EC")"|EC"]", PLACE, EC": ", ADDRESSEE, " dominate point B" = (MSG_TAKEB, ST_ADDRESSED);
