...
#define MP_BACKGROUND "ui/assets/splash11.jpg" // background of the menu
...
#define MP_FOCUSCOLOR 1 0 1 1 1 // focus 
#define MP_BOX_HEADERCOLOR 1 1 1 1 // for the text appearing above editboxes
#define MP_SMALLCOLOR 0.75 0.75 0.75 1 // the smaller options colors
