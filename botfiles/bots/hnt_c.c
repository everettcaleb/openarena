...
skill 1
{
	CHARACTERISTIC_NAME							"Hnt"
	CHARACTERISTIC_GENDER						"female"
	CHARACTERISTIC_ATTACK_SKILL					0.3
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/hnt_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/hnt_t.c"
	CHARACTERISTIC_CHAT_NAME					"hnt"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/hnt_i.c"
