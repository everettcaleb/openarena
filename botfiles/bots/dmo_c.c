...
skill 1
{
	CHARACTERISTIC_NAME							"Dmo"
	CHARACTERISTIC_GENDER						"male"
	CHARACTERISTIC_ATTACK_SKILL					0.30
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/dmo_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/dmo_t.c"
	CHARACTERISTIC_CHAT_NAME					"Dmo"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/dmo_i.c"
