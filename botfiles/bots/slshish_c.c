...
skill 1
{
	CHARACTERISTIC_NAME							"Slshish"
	CHARACTERISTIC_GENDER						"female"
	CHARACTERISTIC_ATTACK_SKILL					0.25
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/slshish_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/slshish_t.c"
	CHARACTERISTIC_CHAT_NAME					"Slshish"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/slshish_i.c"
